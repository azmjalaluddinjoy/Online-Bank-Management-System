...
{/*Here's f,i,j,k,l,m,n,p all are used as counter variable*/
    int option=1,value, sign_in_option=1, sign_in_choice,f=0, i, j=0, k=0, l=0, m=0,n=0,p=0, sign_in_account_number,sign_in_password, signin_money_transfer_account, signin_change_pass_request_previous_password, signin_new_password_step1, signin_new_password_step2, asking_for_password_recover;
